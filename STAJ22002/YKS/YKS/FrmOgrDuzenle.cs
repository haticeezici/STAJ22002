...
namespace YKS
{
    public partial class FrmOgrDuzenle : Form
    {
        ...
        private void FrmOgrDuzenle_Load(object sender, EventArgs e)
        {
            ...
            //veritabanından bölümleri çekme

            SqlCommand komut2 = new SqlCommand("select distinct (BolumAd) from Bolumler", bgl.baglanti());
            SqlDataReader oku2 = komut2.ExecuteReader();
            while (oku2.Read())
            {
                CmbBolum.Items.Add(oku2[0].ToString());
            ...
            // veritabanından odaları çekme

            /*      SqlCommand komut3 = new SqlCommand("select distinct (OdaNo) from Odalar", bgl.baglanti());
