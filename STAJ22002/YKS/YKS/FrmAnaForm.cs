...
namespace YKS
{
    public partial class FrmAnaForm : Form
    {
        ...
        private void gideerEkleToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Bu otomasyon Hatice Ezici tarafından tamamlandı.", "YKS", MessageBoxButtons.OK, MessageBoxIcon.Information);
