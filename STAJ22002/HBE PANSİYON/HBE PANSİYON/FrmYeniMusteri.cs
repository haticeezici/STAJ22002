...
namespace HBE_PANSİYON
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            MessageBox.Show("Turkuaz Renkli Butonlar Boş Odaları Gösterir.");
        }
        ...
        private void DtpCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            ...
            Ucret = Convert.ToInt32(label11.Text) * 2500;
...
//Data Source=DESKTOP-44ELMSQ\SQLEXPRESS;Initial Catalog=hbe;Integrated Security=True
